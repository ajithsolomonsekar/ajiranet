...
public enum AppConstants {
	...
	ERR_007("Strength cannot be defined for a repeater"), COMMAND_CREATE("CREATE"), COMMAND_MODIFY("MODIFY"),
	COMMAND_FETCH("FETCH"), ENDPOINT_001("/devices"), ENDPOINT_002("/connections"), INFO_001("Device already exists"),
