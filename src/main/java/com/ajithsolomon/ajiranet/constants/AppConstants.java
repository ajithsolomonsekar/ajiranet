...
public enum AppConstants {
	...
	ERR_009("Route cannot be calculated with repeater"), COMMAND_CREATE("CREATE"), COMMAND_MODIFY("MODIFY"),
	COMMAND_FETCH("FETCH"), ENDPOINT_001("/devices"), ENDPOINT_002("/connections"), ENDPOINT_003("/devices="),
